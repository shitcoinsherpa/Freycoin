...
class DeriveaddressesTest(BitcoinTestFramework):
    ...
    def run_test(self):
        assert_raises_rpc_error(-5, "is not a valid descriptor function", self.nodes[0].deriveaddresses, "a")
        ...
        address = "rfrey1qjqmxmkpmxt80xz4y3746zgt0q3u3ferr2rg93r"
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), ["rfrey1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqwrqh3n", "rfrey1qpgptk2gvshyl0s9lqshsmx932l9ccsv2pz73ph"])
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, 2), [address, "rfrey1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqwrqh3n", "rfrey1qpgptk2gvshyl0s9lqshsmx932l9ccsv2pz73ph"])
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), [["rfrey1q7c8mdmdktrzs8xgpjmqw90tjn65j5a3yfeqxdy", "rfrey1qs6n37uzu0v0qfzf0r0csm0dwa7prc0v58te4cc"], ["rfrey1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqwrqh3n", "rfrey1qpgptk2gvshyl0s9lqshsmx932l9ccsv2pz73ph"]])
        ...
        # Before #26275, freycoind would crash when deriveaddresses was
        ...
        assert_equal(self.nodes[0].deriveaddresses(descsum_create("wpkh(tprv8ZgxMBicQKsPd7Uf69XL1XwhmjHopUGep8GuEiJDZmbQz6o58LninorQAfcKZWARbtRtfnLcJ5MQ2AtHcQJCCRUcMRvmDUjyEmNUWwx8UbK/1/1/*)"), [2147483647, 2147483647]), ["rfrey1qtzs23vgzpreks5gtygwxf8tv5rldxvvsll5s2l"])
