...
class DecodeScriptTest(BitcoinTestFramework):
    ...
    def decodescript_script_pub_key(self):
        ...
        assert_equal('rfrey1pfeespsh2kx', rpc_result['address'])
    ...
    def decodescript_miniscript(self):
        ...
        assert res["segwit"]["desc"] == "addr(rfrey1q73qyfypp47hvgnkjqnav0j3k2lq3v76wg22dk8tmwuz5sfgv66xsmk9ttj)#ymdu46wl"
