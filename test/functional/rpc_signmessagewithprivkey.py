...
class SignMessagesWithPrivTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(addresses[2], 'rfrey1qvza2pay5kwxw8j2qm6n87wqym3fdr7u5rvqz3u')
        ...
        assert_raises_rpc_error(-3, "Malformed base64 encoding", self.nodes[0].verifymessage, 'rfrey1qvza2pay5kwxw8j2qm6n87wqym3fdr7u5rvqz3u', "invalid_sig", message)
