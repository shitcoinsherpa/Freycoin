...
"""Test objects for interacting with a freycoind node over the p2p protocol.

The P2PInterface objects interact with the freycoind nodes under test using the
