...
complete --command riecoin-qt --no-files

# Extract options
function __fish_riecoinqt_get_options
...
complete \
    --command riecoin-qt \
    --arguments "(__fish_riecoinqt_get_options --nofiles)"
