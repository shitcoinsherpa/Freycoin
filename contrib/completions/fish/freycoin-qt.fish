...
complete --command freycoin-qt --no-files

# Extract options
function __fish_freycoinqt_get_options
...
complete \
    --command freycoin-qt \
    --arguments "(__fish_freycoinqt_get_options --nofiles)"
