...
# Extract options
function __fish_freycoin_tx_get_options
...
# Extract commands
function __fish_freycoin_tx_get_commands
...
complete \
    --command freycoin-tx \
    --condition "not __fish_freycoin_seen_cmd (__fish_freycoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_freycoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command freycoin-tx \
    --arguments "(__fish_freycoin_tx_get_commands)" \
    --no-files
