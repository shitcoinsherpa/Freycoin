...
complete --command freycoind --no-files

# Extract options
function __fish_freycoind_get_options
...
complete \
    --command freycoind \
    --arguments "(__fish_freycoind_get_options --nofiles)"
