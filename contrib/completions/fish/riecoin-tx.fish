...
# Extract options
function __fish_riecoin_tx_get_options
...
# Extract commands
function __fish_riecoin_tx_get_commands
...
complete \
    --command riecoin-tx \
    --condition "not __fish_riecoin_seen_cmd (__fish_riecoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_riecoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command riecoin-tx \
    --arguments "(__fish_riecoin_tx_get_commands)" \
    --no-files
