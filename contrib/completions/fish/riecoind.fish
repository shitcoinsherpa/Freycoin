...
complete --command riecoind --no-files

# Extract options
function __fish_riecoind_get_options
...
complete \
    --command riecoind \
    --arguments "(__fish_riecoind_get_options --nofiles)"
