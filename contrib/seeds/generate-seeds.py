...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef FREYCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define FREYCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the Freycoin network\n')
    ...
    g.write('#endif // FREYCOIN_CHAINPARAMSSEEDS_H\n')
