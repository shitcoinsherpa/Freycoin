...
module.exports = {
	...
	displayDefaults: {
		displayCurrency: (process.env.BTCEXP_DISPLAY_CURRENCY || (currentCoin == "FREY" ? "frey" : "btc")),
	...
	site: {
		...
		prioritizedToolIdsList: [8, 19, 20, 0, 9, 12, 2, 18, 4, 5, 3, 10, 11, 1],
		toolSections: [
			{name: "Math Research", items: [8, 19, 20]},
			{name: "Blockchain", items: [2, 9, 12, 18]},
			{name: "Mempool", items: [4, 5]},
			{name: "Technical", items: [0, 1, 3, 10, 11]},
		]
	},
	...
	/* 8 */		{name:"Prime Gap Records", url:"./prime-gap-records", desc:"Largest prime gaps discovered by miners. Every block advances mathematical knowledge.", iconClass:"bi-trophy"},
	...
	/* 13 */	{name:(coins[currentCoin].name + " Fun"), url:"./fun", desc:"Curated fun/interesting historical blockchain data.", iconClass:"bi-flag"},
	...
	/* 17 */	{name:"UTXO Set", url:"./utxo-set", desc:"View the latest UTXO Set.", iconClass:"bi-list-columns"},

	/* 18 */	{name:"Next Halving", url:"./next-halving", desc:"Estimated details about the next halving.", iconClass:"bi-square-half"},

	/* 19 */	{name:"Global Gap Records", url:"./global-gap-records", desc:"Browse the global Prime Gap List Project database. See which Freycoin-discovered gaps are record-worthy.", iconClass:"bi-globe2"},

	/* 20 */	{name:"Missing Gaps", url:"./missing-gaps", desc:"Gap sizes not yet discovered. Find one and make mathematical history.", iconClass:"bi-search"},
	]
};
