...
/**
 * Minimum difficulty (merit ~16 for testnet, higher for mainnet)
 */
static constexpr uint64_t MIN_DIFFICULTY = 16ULL * TWO_POW48;
static constexpr uint64_t MIN_TEST_DIFFICULTY = TWO_POW48;

/**
 * Shift limits for PoW
 */
static constexpr uint16_t MIN_SHIFT = 14;
static constexpr uint16_t MAX_SHIFT = 256;
