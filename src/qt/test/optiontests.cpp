...
void OptionTests::parametersInteraction()
{
    ...
    // With fListen=false in ~/.config/Freycoin/Freycoin-Qt.conf and all else left as default,
    // freycoin-qt should set both -listen and -listenonion to false and start successfully.
