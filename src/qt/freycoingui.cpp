...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Freycoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and freycoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Freycoin addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Freycoin addresses"));
    m_load_psbt_action = new QAction(tr("&Load PSBT from file…"), this);
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Freycoin Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSRT/PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Freycoin Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a freycoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Freycoin command-line options").arg(CLIENT_NAME));
